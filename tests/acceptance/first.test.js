...
fixture('Website').page('../../src/index.html')
...
test('On launch"', async browser => {
    ...
    .expect(Selector('[data-timelines="0"]').innerText).contains('The Beatles')
    .expect(Selector('[data-timelines="1"]').innerText).contains('The Rolling Stones')
    ...
    .expect(Selector('[data-timelines="axis"]').innerText).contains('1962')
    .expect(Selector('[data-timelines="axis"]').innerText).contains('1986')
    .expect(Selector('[data-timelines="axis"]').innerText).contains('2021')
